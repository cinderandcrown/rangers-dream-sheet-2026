    ...
    <div className="mb-5 rounded-2xl border border-white/[0.06] bg-[var(--slate)] p-6">
      ...
      <div className="mb-5 space-y-2">
        {members.map((member) => {
          ...
          return (
            <div key={member.name} className="flex flex-wrap items-center gap-3 rounded-xl border border-white/[0.04] bg-white/[0.02] px-4 py-3">
              <div className="flex items-center gap-2.5 min-w-[120px]">
                <span className="inline-block h-3 w-3 rounded-full" style={{ background: member.accent_color }} />
